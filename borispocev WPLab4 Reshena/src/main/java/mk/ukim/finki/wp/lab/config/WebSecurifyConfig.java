...
public class WebSecurifyConfig{

    private final PasswordEncoder passwordEncoder;

    public WebSecurifyConfig(PasswordEncoder passwordEncoder) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((req) -> req
                        .requestMatchers("/", "/album", "/songs").permitAll()
                        .requestMatchers("/album/delete/**").hasRole("ADMIN")
                        .requestMatchers("/songs/delete/**").hasRole("ADMIN")
                        .requestMatchers("/album/**", "/songs/**").hasAnyRole("ADMIN", "MODERATOR")
